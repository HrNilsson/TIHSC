...
\begin{enumerate}
  ...
  \item \textbf{Model of computation}\\*
  		With the blocks of the system in place the actual computation of the system can be modeled. A Model of Computation (MoC) is a generalized way of describing system behavior in an abstract, conceptual form. In this project activity diagrams is used for this.
  \item \textbf{System behavioral model}\\*
  		By analyzing the activity diagram different processes in the system can be isolated which then can be illustrated in a system behavioral model with processes, channels and memory
